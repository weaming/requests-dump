...
setup(
    name=name,  # Required
    version=get_version("requests_dump.py"),  # Required
    # This is a one-line description or tagline of what your project does.
    description="dump requests' requests http message content to stderr or your custom file",  # Required
